...
export interface IDownloadFromWorkbenchRef {
...
export const DownloadFromWorkbench = forwardRef<IDownloadFromWorkbenchRef, IDownloadFromWorkbenchProps>((props, ref) => {
    ...
    const self = useRef({
        checkin: async () => {
            ...
            let data = await services.getDataByID(dataID) as IDocumentRecord[];
            try {
                let nextStepRatio = 1;
                let nextStepStart = 0;
                await services.downloadFilesToWorkspceAsync(data, progress => {
